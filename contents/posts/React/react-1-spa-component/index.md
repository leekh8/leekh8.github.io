---
title: "📘 React 입문: SPA, 컴포넌트, JSX 핵심 개념 완전 정리"
description: "React의 핵심 개념인 SPA, 컴포넌트 기반 개발, JSX 문법을 처음부터 정리합니다. Virtual DOM의 동작 원리, 함수형 컴포넌트 작성법, React 개발 환경 구성까지 한 번에 배웁니다."
date: 2023-05-01
update: 2024-03-27
tags:
  - React
...
- [⚡ JavaScript 비동기 처리 완전 가이드](/javascript-async/) — React를 배우기 전에 알아야 할 JS 비동기 처리
