...
const explain1 = `${animal1} has ${legs1} legs.
${animal1} says "meow".`;
...
// "duck", "quack"
const duck3 = new Animal3('duck', 'quack');

module.exports = duck3;
...
// 실행 시 함수를 세 번 시행하고
// 각각 add_all(1, 2, 3), add_all(4, 5, 0), add_all(6, 0, 7)이 실행
